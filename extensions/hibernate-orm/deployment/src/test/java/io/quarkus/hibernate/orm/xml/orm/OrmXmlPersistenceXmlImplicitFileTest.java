...
public class OrmXmlPersistenceXmlImplicitFileTest {
    ...
    static QuarkusUnitTest runner = new QuarkusUnitTest()
            .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
                    ...
                    .addAsManifestResource("META-INF/implicitormxml.persistence.xml", "persistence.xml")
                    .addAsManifestResource("META-INF/simple.orm.xml", "orm.xml")
                    .addAsResource("application-datasource-only.properties"));
